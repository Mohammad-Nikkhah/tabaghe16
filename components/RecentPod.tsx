    ...
    <div className='py-30' id='podcast'>
      ...
      <div className='flex flex-wrap items-center justify-center p-4 gap-x-16 gap-y-8 mt-10'>
         {projects.map(({id,title,img,company,link})=> (
              <div className='sm:h-[41rem] h-[32rem] lg:min-h-[32.5rem]  flex items-center justify-center
                sm:w-[570px] w-[80vw]
              ' key={id}>
                  <PinContainer title="Click" href={link}>
                     <div className='relative flex items-center justify-center sm:w-[570px] w-[80vw]
                       overflow-hidden 
                       lg:h-[30vh] h-[30vh] mb-10 sm:h-[40vh]
                     '>
                     ...
                     <div className='flex items-center justify-between mt-7 mb-3'>
                           <div className='flex items-center'>
                              <img width="50" height="50" className='rounded-3xl' src={company}/>
